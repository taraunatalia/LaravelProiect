...
update-cart" />
 ...
 <button class="btn btn-danger btn-sm remove-from-cart"><i class="fa fa-trasho"></i>REMOVE</button>
 </td>
 </tr>
 @endforeach
 @endif
 ...
 <tfoot>
 <tr>
 <td colspan="5" class="text-right"><h3><strong>Total {{ $total }} RON</strong></h3></td>
 </tr>
 <tr>
